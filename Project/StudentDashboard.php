...
<body class="sb-nav-fixed">
    ...
    $stdemail = $_POST['stemail'];
    $stdpassword = $_POST['stpassword'];

    $conn = new mysqli($servername, $username, $password, $database);
    if ($conn->error) {
        echo 'Error' . $conn->error;
    } else {
        $sql = "SELECT `Username` from `studentsrecord` WHERE `Email` = '" . $stdemail . "'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo '                   <div class="small"> <a href="./StudentLogin.php">Logged Out</a></div>';
            echo '               </div>';
            echo '           </nav>';
            echo '       </div>';
            ...
            echo '                               <div class="card-body"> <i class="bx bx-edit-alt icon"></i></div>';
            echo '                               <div class="card-footer d-flex align-items-center justify-content-between">';
            echo '                                    <a class="small text-white stretched-link" href="./Activity1.php">Active Test</a>';
            ...
            echo '                                <div class="card-body"><i class="bx bx-book-reader icon"></i></div>';
            echo '                                <div class="card-footer d-flex align-items-center justify-content-between">';
            echo '                                    <a class="small text-white stretched-link" href="./Assingment.php">New Assingment</a>';
            echo '                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>';
            echo '                                </div>';
            echo '                            </div>';
            echo '                        </div>';
            ...
            echo '                                <div class="card-body"><i class="bx bx-objects-vertical-bottom icon"></i></div>';
            echo '                                <div class="card-footer d-flex align-items-center justify-content-between">';
            echo '                                    <a class="small text-white stretched-link" href="#">Result</a>';
            echo '                                   <div class="small text-white"><i class="fas fa-angle-right"></i></div>';
            echo '                                </div>';
            echo '                            </div>';
            echo '                        </div>';
            ...
            echo '                                <div class="card-body"><i class="bx bx-minus-back icon"></i></div>';
            echo '                                <div class="card-footer d-flex align-items-center justify-content-between">';
            echo '                                    <a class="small text-white stretched-link" href="./StdFeadback.php">Feadback</a>';
            echo '                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>';
            echo '                                </div>';
            echo '                            </div>';
            echo '                        </div>';
            ...
            echo '                       <p class="lead">You Dont Have An Account <a Href="./Student Registration.php">Creatre Now</a></p>';
            echo '                       </a>';
            echo '                    </div>';
            echo '                </div>';
            echo '             </div>';
